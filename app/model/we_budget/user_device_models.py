...
class UserDeviceModels(BaseWeBudget, Stamp):
    __tablename__ = "tbl_user_device"

    id = Column(Integer, primary_key=True, index=True)
    device_id = Column(String, nullable = False, index =True)
    uid = Column(String,ForeignKey("tbl_user.uid"), nullable = False, index=True) ## in my ERD this is ForeignKey, how to implement
